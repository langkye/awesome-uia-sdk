...
dependencies {
    ...
    api(platform(libs.junitBom.get()))
    ...
    constraints {
        ...
        api("com.google.protobuf:protobuf-java:${libs.versions.protobufJava.get()}")
        ...
        api("org.apache.commons:commons-collections4:${libs.versions.commonsCollections4.get()}")
        api("commons-codec:commons-codec:${libs.versions.commonsCodec.get()}")
        api("com.alibaba:fastjson:${libs.versions.fastjson2.get()}")
        api("com.alibaba.fastjson2:fastjson2:${libs.versions.fastjson2.get()}")
        api("com.alibaba.fastjson2:fastjson2-kotlin:${libs.versions.fastjson2.get()}")
        api("com.alibaba.fastjson2:fastjson2-extension:${libs.versions.fastjson2.get()}")
        api("com.alibaba.fastjson2:fastjson2-extension-spring6:${libs.versions.fastjson2spring6.get()}")
        api("org.jetbrains.kotlinx:kotlinx-serialization-json:${libs.versions.kotlinxSerializationJson.get()}")
        api("com.google.code.gson:gson:${libs.versions.gson.get()}")
        api("com.alibaba:transmittable-thread-local:${libs.versions.transmittableThreadLocal.get()}")
        api("org.yaml:snakeyaml:${libs.versions.snakeyaml.get()}")
        api("io.swagger:swagger-annotations:${libs.versions.swagger1.get()}")
        api("io.swagger.core.v3:swagger-annotations:${libs.versions.swagger3.get()}")
        ...
        api("com.google.auto.service:auto-service-annotations:${libs.versions.autoService.get()}")
        api("com.google.auto.service:auto-service:${libs.versions.autoService.get()}")
        api("io.leopard:javahost:${libs.versions.javahost.get()}")
        api("io.vavr:vavr:${libs.versions.vavr.get()}")
        // 加密
        api("org.bouncycastle:bcprov-jdk15to18:${libs.versions.bcprovJdk15to18.get()}")
        api("org.bouncycastle:bcprov-jdk18on:${libs.versions.bcprovJdk18on.get()}")
        // sdk
        api("com.alipay.sdk:alipay-sdk-java:${libs.versions.alipaySdkJava.get()}")
        api("junit:junit:${libs.versions.junit.get()}")
    }
}
